...
class RecommendationAgent:
    ...
    def generate_recommendations(self, violations_data: List[Dict[str, Any]], 
                               paired_contexts: List[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        Generate recommendations based on violation data
        
        Args:
            violations_data: List of violations from violation detector
            paired_contexts: Optional context about document-policy pairs
        ...
        try:
            ...
            prompt = self._build_recommendation_prompt(violations_data, paired_contexts)
    ...
    def _build_recommendation_prompt(self, violations: List[Dict], contexts: List[Dict] = None) -> str:
        """Build the prompt for recommendation generation"""
        
        violations_text = json.dumps(violations, indent=2)
        contexts_text = json.dumps(contexts, indent=2) if contexts else "No additional context provided"
...
"""
    ...
    def _parse_recommendations(self, response_text: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if isinstance(recommendations, list):
                ...
                return [recommendations]  # Single recommendation wrapped in list
            ...
            # If all parsing fails, return a generic recommendation
            return [{
    ...
    def _calculate_confidence(self, violations: List[Dict], recommendations: List[Dict]) -> float:
        ...
        # Adjust based on recommendation completeness
